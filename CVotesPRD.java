...
/**
 * Servlet implementation class Cmenu
 */
@WebServlet(description = "Servlet to process the information", urlPatterns = { "/CVotesPRD" })
public class CVotesPRD extends HttpServlet {
